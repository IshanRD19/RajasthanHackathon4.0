...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(profile!=None):
            cv2.putText(im,str(profile[1]), (x,y+h+30),font, 0.8, (0,255,0))
            cv2.putText(im,str(profile[2]), (x,y+h+60),font, 0.8, (0,255,0))
            cv2.putText(im,str(profile[3]), (x,y+h+90),font, 0.8, (0,255,0))
